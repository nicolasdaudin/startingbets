            ...
            <TableBody>
              {this.props.users.map( (journey) => (
                <TableRow key={journey.id}>              
                  ...
                  <TableCell></TableCell>
                  <TableCell>{journey.disabled ? '' : <Link to="/admin/journey/1">Journey (vue Admin)</Link>}</TableCell>
                  <TableCell>{journey.disabled ? '' : <Link to="/user/journey/1">Journey (vue User)</Link>}</TableCell>
